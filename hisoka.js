...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
	...
	try {
        ...
        if (m.message) {
            ...
            console.log(chalk.black(chalk.bgWhite('[ ᴘᴇsᴀɴ ]')), chalk.black(chalk.bgGreen(new Date)), chalk.black(chalk.bgBlue(budy || m.mtype)) + '\n' + chalk.magenta('=> ᴅᴀʀɪ'), chalk.green(pushname), chalk.yellow(m.sender) + '\n' + chalk.blueBright('=> ᴅɪ'), chalk.green(m.isGroup ? pushname : 'ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ', m.chat))
        }
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Anti Link
        ...
        m.reply(`「 ᴀɴᴛɪ ʟɪɴᴋ 」\n\nᴋᴀᴍᴜ ᴛᴇʀᴅᴇᴛᴇᴋsɪ ᴍᴇɴɢɪʀɪᴍ ʟɪɴᴋ ɢʀᴏᴜᴘ, ᴍᴀᴀғ ᴋᴀᴍᴜ ᴀᴋᴀɴ ᴅɪ ᴋɪᴄᴋ !`)
        if (!isBotAdmins) return m.reply(`ᴇʜʜ ʙᴏᴛ ʙᴜᴋᴀɴ ᴀᴅᴍɪɴ ᴛ_ᴛ`)
        let gclink = (`https://chat.whatsapp.com/`+await hisoka.groupInviteCode(m.chat))
        let isLinkThisGc = new RegExp(gclink, 'i')
        let isgclink = isLinkThisGc.test(m.text)
        if (isgclink) return m.reply(`ᴇʜʜ ᴍᴀᴀғ ɢᴀᴋ ᴊᴀᴅɪ, ᴋᴀʀᴇɴᴀ ᴋᴀᴍᴜ ɴɢɪɪʀᴍ ʟɪɴᴋ ɢʀᴏᴜᴘ ɪɴɪ`)
        if (isAdmins) return m.reply(`ᴇʜʜ ᴍᴀᴀғ ᴋᴀᴍᴜ ᴀᴅᴍɪɴ`)
        if (isCreator) return m.reply(`ᴇʜʜ ᴍᴀᴀғ ᴋᴀᴍᴜ ᴏᴡɴᴇʀ ʙᴏᴛ ᴋᴜ`)
...
`.trim(), m, { mentions: [roof.p, roof.p2] })
	    ...
	    for (let jid of mentionUser) {
            ...
            m.reply(`
ᴊᴀɴɢᴀɴ ᴛᴀɢ ᴅɪᴀ!
ᴅɪᴀ sᴇᴅᴀɴɢ ᴀғᴋ ${reason ? 'ᴅᴇɴɢᴀɴ ᴀʟᴀsᴀɴ ' + reason : 'ᴛᴀɴᴘᴀ ᴀʟᴀsᴀɴ'}
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            break
            case 'donasi': {
            hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/2bfcb9235dfb58bcf3826.jpg' }, caption: `*ʜᴀɪ ᴋᴀᴋ ${m.pushName}*\n\n┏━━━━━━━━━━━⬣
┃   〔 ᴅᴏɴᴀsɪ ʙᴏᴛ  〕
┃▰▰▰▰▰▰▰▰▰
┃⬣ ᴅᴀɴᴀ:0821-4886-4989
┃⬡ ɢᴏᴘᴀʏ:0821-4886-4989
┃▰▰▰▰▰▰▰▰▰` }, { quoted: m })
            }
break	
...
┃ᴅᴀɴᴀ : 0821-4886-4989
┃ɢᴏᴘᴀʏ : 0821-4886-4989
┃Pulsa : 0821-4886-4989
┃
┃ɴᴏᴛᴇ :
┃ᴊɪᴋᴀ sᴜᴅᴀʜ ᴛʀᴀɴsғᴇʀ ᴡᴀᴊɪʙ ᴋɪʀɪᴍ
┃ʙᴜᴋᴛɪ ᴛʀᴀɴsғᴇʀ ᴋᴇ ɴᴏᴍᴏʀ ᴅɪ ʙᴀᴡᴀʜ
┃ᴀɢᴀʀ ʙɪsᴀ ᴄᴇᴘᴀᴛ ᴅɪ ᴘʀᴏsᴇs ʟᴀɴɢsᴜɴɢ
┃
┃ᴄᴘ : Wa.me/6282148864989 〔ᴏᴡɴᴇʀ〕
┃▰▰▰▰▰▰▰▰▰▰▰▰▰▰

_ʙᴜᴋᴀɴ ʙᴏᴛ_ _ᴋᴜʀᴜᴍɪ-ᴍᴅ_👍🏻
▌│█║▌║▌║║▌║▌║█│▌` }, { quoted: m })
            }
            break
            case 'sc': {
...
break
            ...
            break
            case 'menu': case 'help': {
            anu = `ʜᴀɪ ᴋᴀᴋ ${m.pushName}*
sᴀʏᴀ ᴋᴜʀᴜᴍɪ-ᴍᴅ ʏᴀɴɢ ᴅɪ ʙᴜᴀᴛ ᴏʟᴇʜ ʀᴇɴғᴜɴɪx 
ʏᴀɴɢ ᴍᴇᴍᴘᴇʀᴍᴜᴅᴀʜᴋᴀɴ ᴋᴀᴍᴜ ᴊɪᴋᴀ ᴀᴅᴀ ғɪᴛᴜʀ ᴇʀʀᴏʀ ᴀᴛᴀᴜ ʙᴜɢ sᴇɢᴇʀᴀ ʟᴀᴘᴏʀᴋᴀɴ ᴋᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙᴏᴛ
ʀᴜɴᴛɪᴍᴇ: _${runtime(process.uptime())}_
ᴛᴀɴɢɢᴀʟ: _${moment.tz('Asia/Jakarta').format('DD/MM/YY')}_
Waktu: _${moment.tz('Asia/Jakarta').format('HH:mm:ss')}_
            
╭────[ *ʀᴜʟᴇs* ]────✧
┴
│ ᴅɪʟᴀʀᴀɴɢ sᴘᴀᴍ ᴄᴏᴍᴍᴀɴᴅ
│ ᴅɪʟᴀʀᴀɴɢ ᴋɪʀɪᴍ ᴠɪʀᴛᴇx
│ ᴅɪʟᴀʀᴀɴɢ sᴘᴀᴍ ᴍᴇɴᴜ ɢᴀ ᴊᴇʟᴀs
│ ᴅɪʟᴀʀᴀɴɢ ᴛᴇʟᴘ / ᴠᴄ
│ ᴅɪʟᴀʀᴀɴɢ ᴄᴜʟɪᴋ ʙᴏᴛ
│ ᴅɪʟᴀʀᴀɴɢ ᴍᴇɴɪʀᴜ ᴘᴇsᴀɴ ʙᴏᴛ
│ ᴅɪʟᴀʀᴀɴɢ ᴄʜᴀᴛ ᴏᴡɴᴇʀ ɢᴀ ᴊᴇʟᴀs
┬
╰──────────···`
                let btn = [{
                                urlButton: {
...
ᴀʟᴀsᴀɴ: ${vote[m.chat][0]}

┌〔 ᴜᴘᴠᴏᴛᴇ 〕
│ 
├ ᴛᴏᴛᴀʟ: ${vote[m.chat][1].length}
│
│ 
└────
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                if (!isAdmins) throw mess.admin
                if (args[0] === 'close'){
                    await hisoka.groupSettingUpdate(m.chat, 'announcement').then((res) => m.reply(`sᴜᴋsᴇs ᴍᴇɴᴜᴛᴜᴘ ɢʀᴜᴘ`)).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'open'){
                    await hisoka.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m.reply(`sᴜᴋsᴇs ᴍᴇᴍʙᴜᴋᴀ ɢʀᴜᴘ`)).catch((err) => m.reply(jsonformat(err)))
                } else {
                let buttons = [
            ...
            case 'editinfo': {
                ...
                if (!isAdmins) throw mess.admin
             if (args[0] === 'open'){
                await hisoka.groupSettingUpdate(m.chat, 'unlocked').then((res) => m.reply(`sᴜᴋsᴇs ᴍᴇᴍʙᴜᴋᴀ ᴇᴅɪᴛ ɪɴғᴏ ɢʀᴜᴘ`)).catch((err) => m.reply(jsonformat(err)))
             } else if (args[0] === 'close'){
                await hisoka.groupSettingUpdate(m.chat, 'locked').then((res) => m.reply(`sᴜᴋsᴇs ᴍᴇɴᴜᴛᴜᴘ ᴇᴅɪᴛ ɪɴғᴏ ɢʀᴜᴘ`)).catch((err) => m.reply(jsonformat(err)))
             } else {
             let buttons = [
            ...
            case 'antilink': {
                ...
                if (!isAdmins) throw mess.admin
                if (args[0] === "on") {
                if (db.data.chats[m.chat].antilink) return m.reply(`sᴜᴅᴀʜ ᴀᴋᴛɪғ sᴇʙᴇʟᴜᴍɴʏᴀ`)
                db.data.chats[m.chat].antilink = true
                m.reply(`ᴀɴᴛɪʟɪɴᴋ ᴛᴇʟᴀʜ ᴀᴋᴛɪғ !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].antilink) return m.reply(`sᴜᴅᴀʜ ᴛɪᴅᴀᴋ ᴀᴋᴛɪғ sᴇʙᴇʟᴜᴍɴʏᴀ`)
                db.data.chats[m.chat].antilink = false
                m.reply(`ᴀɴᴛɪʟɪɴᴋ ᴛᴇʟᴀʜ ɴᴏɴᴀᴋᴛɪғ !`)
                } else {
                 let buttons = [
             ...
             case 'mute': {
                ...
                if (!isAdmins) throw mess.admin
                if (args[0] === "on") {
                if (db.data.chats[m.chat].mute) return m.reply(`sᴜᴅᴀʜ ᴀᴋᴛɪғ sᴇʙᴇʟᴜᴍɴʏᴀ`)
                db.data.chats[m.chat].mute = true
                m.reply(`${hisoka.user.name} ᴛᴇʟᴀʜ ᴅɪ ᴍᴜᴛᴇ ᴅɪ ɢʀᴜᴘ ɪɴɪ !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`sᴜᴅᴀʜ ᴛɪᴅᴀᴋ ᴀᴋᴛɪғ sᴇʙᴇʟᴜᴍɴʏᴀ`)
                db.data.chats[m.chat].mute = false
                m.reply(`${hisoka.user.name} ᴛᴇʟᴀʜ ᴅɪ ᴜɴᴍᴜᴛᴇ ᴅɪ ɢʀᴜᴘ ɪɴɪ !`)
                } else {
                 let buttons = [
            ...
            case 'delete': case 'del': {
                ...
                if (!isBaileys) throw 'ᴘᴇsᴀɴ ɪᴛᴜ ᴛɪᴅᴀᴋ ᴅɪᴋɪʀɪᴍ ᴏʟᴇʜ ʙᴏᴛ ɪɴɪ!'
		...
		m.reply('Sukses Broadcast')
            ...
            case 'infochat': {
                ...
                if (!m.quoted.isBaileys) throw 'ᴘᴇsᴀɴ ɪᴛᴜ ᴛɪᴅᴀᴋ ᴅɪᴋɪʀɪᴍ ᴏʟᴇʜ ʙᴏᴛ ɪɴɪ!'
                let teks = ''
                for (let i of msg.userReceipt) {
                    ...
                    teks += ` ┗━⭔ *ᴡᴀᴋᴛᴜ :* ${moment(waktu * 1000).format('DD/MM/YY HH:mm:ss')} ⭔ *Status :* ${read ? 'Dibaca' : 'Terkirim'}\n\n`
                }
            ...
            case 'listpc': {
             ...
             break
                case 'listgc': {
                 ...
                 let teks = `⬣ *ʟɪsᴛ ɢʀᴏᴜᴘ ᴄʜᴀᴛ*\n\nᴛᴏᴛᴀʟ ɢʀᴏᴜᴘ : ${anu.length} Group\n\n`
                 for (let i of anu) {
             ...
             case 'listonline': case 'liston': {
                    ...
                    hisoka.sendText(m.chat, 'ʟɪsᴛ ᴏɴʟɪɴᴇ:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
...
⭔ ᴜʀʟ : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
            ...
            break
             case 'waifus': case 'ero': case 'oral': case 'paizuri': case 'ass': case 'hentai': case 'milf': case 'ecchi': case 'nekos': case 'trap': case 'blowjob': {
                m.reply(mess.wait)
                hisoka.sendMessage(m.chat, { image: { url: api('zenz', '/randomanime/'+command, {}, 'apikey') }, caption: 'ʙᴀᴋᴀ ʜᴇɴᴛᴀɪ >///<' + command }, { quoted: m})
            }
            break
            case 'anime': case 'cosplayers': case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'maid': case 'uniform': case 'marin-kitagawa': case 'mori-calliope': case 'raiden-shogun': case 'oppai': case 'selfies': {
                m.reply(mess.wait)
                hisoka.sendMessage(m.chat, { image: { url: api('zenz', '/randomanime/'+command, {}, 'apikey') }, caption: 'ᴋᴀᴡᴀɪ >< ' + command }, { quoted: m })
            }
            break
	    case 'couple': {
                m.reply(mess.wait)
...
_ᴘᴇᴍᴀᴋᴀɪᴀɴ ᴍᴇᴍᴏʀɪ ɴᴏᴅᴇᴊs_
${Object.keys(used).map((key, _, arr) => `${key.padEnd(Math.max(...arr.map(v=>v.length)),' ')}: ${formatp(used[key])}`).join('\n')}

${cpus[0] ? `_ᴛᴏᴛᴀʟ ᴘᴇɴɢɢᴜɴᴀᴀɴ ᴄᴘᴜ_
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            teks += `⭔ ɴᴀᴍᴇ : ${i.name}\n`
            teks += `⭔ ʟɪɴᴋ : ${i.link}\n`
            teks += `⭔ ᴅᴇᴠᴇʟᴏᴘᴇʀ : ${i.developer}\n`
            teks += `⭔ ʟɪɴᴋ ᴅᴇᴠᴇʟᴏᴘᴇʀ : ${i.link_dev}\n\n──────────────────────\n`
            }
            m.reply(teks)
            }
            break
